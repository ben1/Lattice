...
// Tell Windows we are DPI Aware so that it doesn't try to scale the app
...
int main(int argc, char*argv[])
{
    ...
    SDL_Window* window = SDL_CreateWindow("Stronghold", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1920, 1080, window_flags);
    ...
    // Load Default Font
    io.Fonts->AddFontFromFileTTF("Data/Fonts/Cousine-Regular.ttf", 18.0f);
